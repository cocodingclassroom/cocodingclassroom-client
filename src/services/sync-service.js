...
export class SyncService {
    ...
    static connectAndSetup(url, createRoom, classroomID, password, connectedCallback) {
        if (SyncService.#instance === undefined) SyncService.#instance = new SyncService()
    ...
    static connectAndSetupWithHash(url, createRoom, classroomID, hash, connectedCallback) {
        if (SyncService.#instance === undefined) SyncService.#instance = new SyncService()
        let options = {
            params: {
                authID: classroomID,
    ...
    static connectWithOptions(url, classroomID, options, connectedCallback) {
        ...
        let websocketProvider = new WebsocketProvider(url, classroomID, this.#instance.#yDoc, options)
