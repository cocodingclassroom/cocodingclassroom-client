...
import { cursorTipStyle, menuBackground3, menuBorder1, menuRowStyles, toolTipStyle } from '../../util/shared-css'
        ...
        return html`
            <div class="cc-controls-row-container">
                ...
                ${UserService.get().localUser.isTeacher()
                    ...
                    : html` <div class="cc-controls-row">${this._renderActionsForStudents()}</div>`}
            </div>
        `
    }
    ...
    _renderActionsForTeacher = () => {
        return html`
            ...
            <div class="cc-controls-row">
                ...
                <div data-tip="Sync split-screen" @click="${() => forceSplitView()}" class="bg2">
