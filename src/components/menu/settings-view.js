...
export class SettingsView extends LitElement {
            ...
            <div class="settings-panel col">
                ${UserService.get().localUser.isTeacher()
                    ? html` <div>Classroom</div>
                          <div class="line"></div>
                          <div class="row">
                              <div class="grow" data-tip="Set Classroom Mode" data-tip-left>Mode</div>
                              <div>
                                  <input
                          ...
                          <div class="row center-cross-axis" data-tip="Auto compile on keyup" data-tip-left>
                              <input
                                  id="live-coding"
                                  type="checkbox"
                          ...
                          <div class="row center-cross-axis" data-tip="Display code line numbers" data-tip-left>
                              <input
                                  id="line-numbers"
                                  type="checkbox"
                          ...
                          <div class="row center-cross-axis" data-tip="Anyone can lock their own room" data-tip-left>
                              <input
                                  id="room-locks"
                                  type="checkbox"
                          ...
                          <div class="row" data-tip="Time stayed in each room during 'Walk Rooms'" data-tip-left>
    ...
    _onChangeLiveCoding = () => {
        ClassroomService.get().classroom.liveCoding = this.renderRoot.getElementById('live-coding').checked
        this.requestUpdate()
    }

    _onChangeWalkDelay() {
        ClassroomService.get().classroom.walkDelay = this.renderRoot.getElementById('walk-delay').value
        this.requestUpdate()
    }

    _onChangeLineNumbers() {
        ClassroomService.get().classroom.lineNumbers = this.renderRoot.getElementById('line-numbers').checked
        this.requestUpdate()
    }

    _onChangeRoomLocks() {
        ClassroomService.get().classroom.roomLocks = this.renderRoot.getElementById('room-locks').checked
    ...
    _onChangeEditorFontSize() {
        UserService.get().localUser.editorFontSize = this.renderRoot.getElementById('font-size').value
        this.requestUpdate()
    }
